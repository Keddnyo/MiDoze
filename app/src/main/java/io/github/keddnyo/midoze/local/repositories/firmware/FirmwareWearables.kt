...
import io.github.keddnyo.midoze.local.models.firmware.FirmwareApplication
import io.github.keddnyo.midoze.local.models.firmware.FirmwareWearable

val firmwareWearables = arrayOf(
    ...
    FirmwareWearable(
        ...
        firmwareApplication = FirmwareApplication.ZeppLife
    ),
    FirmwareWearable(
    ...
    FirmwareWearable(
        ...
        deviceSource = 73,
        productionSource = 256,
        firmwareApplication = FirmwareApplication.Zepp
    ),
    FirmwareWearable(
