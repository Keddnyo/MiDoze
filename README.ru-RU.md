...
| Возможности | Android 4.0+ | Android 5.0+ | Android 7.0+ |
| --- | --- | --- | --- |
| Полный доступ | Режим совместимости | **Да** | **Да** |
| Лента прошивок | Нет | **Да** | **Да** |
| Поиск | Нет | **Да** | **Да** |
| Страница с прошивкой | Нет | **Да** | **Да** |
| Ярлыки | Нет | Нет | **Да** |
| Настройки | Нет | **Да** | **Да** |
| Тёмный режим | Нет | **Да** | **Да** |
| Ручной запрос | **Да** | **Да** | **Да** |
| Отправка контента | Только ручной запрос | **Да** | **Да** |
